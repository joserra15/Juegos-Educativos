...
async function cargarMundoContenido(id){
  ...
  const mensajes = contenidoMundo.mensajes || {};
  mensajesAcierto = mensajes.acierto || ["¡Muy bien!", "¡Genial!", "¡Sigue así!"];
  mensajesError = mensajes.error || ["Inténtalo otra vez", "Casi lo tienes", "Lee con calma"];
  mensajesUltima = mensajes.ultima || ["¡Última pregunta de la fase!"];
  mensajesPredefinidos = contenidoMundo.mensajesPredefinidos || {};
  CONFIG_MURAL = contenidoMundo.configMural || { maxMensajesDia: 10, puntosPorMensaje: 250 };
